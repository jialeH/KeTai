...
<body style="background-image: url(images/u=3627017597,71029089&fm=23&gp=0.jpg); background-attachment: fixed;"" >
	
<!-- header section -->

<!--header navigation -->

    <div class="header-content clearfix"> <a class="logo" href="index.html"><img src="images/zfnyw53dcqn.png" width="100" alt="è¿å"></a>
     <div style="float: right;"><h1 style="color: white;" >æºèªåå¤§</h1></div></div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-5 col-sm-5">
        <div class="bio"> <img src="img/IMG_3283.JPG" style="border:5pxÂ solidÂ aqua;"" alt="" class="img-responsive"/> </div>
      </div>
      <div class="col-md-7 col-sm-7">
        <div class="bio"> 
          <div class="bio-content">
            <h1 style="color: #00B7EE; font-family: 'å¾®è½¯éé»';">æ¨ é«</h1>
            <h4 style="color: #BDEBEE;">UX/UI Designer, team introduction</h4>
            <h5 style="color: white;">
            <p>å¬å¸æ¥æä¸æ¯å¯æææ°çå¢éï¼æä»¬çå¢éæåæ¥èªäºæ¹åæµ·ï¼ä¸ºäºä¸ä¸ªå±åçæ¢¦æ³èµ°å°äºä¸èµ·ãæä»¬è½ç¶æ¥æä¸åçæ§æ ¼ãæè²èæ¯åå·¥ä½ç»åï¼ä½é½æä¸ä¸ªå±åçç¹ç¹ï¼ç­ç±äºèç½ãç­ç±ææºæ¸¸æï¼.</p>
            <p>æä»¬æ¿æåå°ï¼ä½åºè´ä¸°åï¼æä»¬æ´»åæ éï¼ä¹åæ ·èå¾ä½å¯å¯ï¼æä»¬æ»¡æçæ³ï¼èè¸å®å°å»å®ç°ï¼æä»¬åæ³æ éï¼æä»¬æç»å¹³åº¸ï¼</p>
            <p>å¨è¿éï¼æä»¬ä¼å¿äºè¡¥ï¼ä¸ç¨æå¿èªå·±æ³æ³çå®æ½å±éäºèªå·±çè½åèå´ï¼å¨è¿éï¼æä»¬çæ¯ä¸ªæ³æ³é½ä¼å¾å°å¢éä¸­è¯çæè§ï¼æç»è¶äºå®ç¾ï¼å¨è¿éï¼æä»¬å¨ä¸èµ·ï¼æ²¡ææ²é«åå¯¡ï¼åªæç¥å·±ç¸ä¼´ï¼å¨è¿éï¼æä»¬çå·¥ä½åå°åºå¾çè¯å®ï¼ä»åºä¸å®æåæ¥ï¼</p>
         	</h5>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="col-md-12">
        ...
        <p>Â© 2015 All rights reserved. All Rights Reserved<br>
          More Templates <a href="#" target="_blank" title="æ¨¡æ¿ä¹å®¶">ITå¢é</a> - Collect from <a href="#" title="ç½é¡µæ¨¡æ¿" target="_blank">ç®¡çç³»ç»</a></p>
      </div>
    </div>
  </div>
</footer>
