...
<article class="page-container">
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>å§åï¼</label>
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">æå±é¨é¨ï¼</label>
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" name="adminRole" size="1">
				<option value="0">æè´¨é¨</option>
				<option value="1">å­¦æ¯é¨</option>
				<option value="2">åçé¨</option>
				<option value="3">å°±ä¸é¨</option>
				<option value="4">è´¢å¡é¨</option>
				<option value="5">å¨è¯¢é¨</option>
				<option value="6">äººäºé¨</option>
				<option value="7">å¸åºé¨</option>
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">æ¯å¦ä½¿ç¨è¯ç¨æä¸¤ä¸ªæï¼</label>
		<div class="formControls col-xs-8 col-sm-9"> <input type="radio" checked="checked" name="shiyong" />æ¯&nbsp;<input type="radio" name="shiyong"/>å¦&nbsp;</div>
	</div>
	<div class="row cl">
